...
interface IComptroller {
    ...
    function getCurrentBorrowSpeed(address cToken) external returns (uint256);

    function getCurrentSupplySpeed(address cToken) external returns (uint256);
    ...
    function reductionPeriod() external view returns (uint256);
    ...
    function startSpeedTime() external view returns (uint256);
